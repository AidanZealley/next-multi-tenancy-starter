...
import {
  ...
  useOrganisationMembershipsQuery,
  useOrganisationInvitesQuery,
...
const OrganisationSelectionPage = ({
  ...
  const { organisationInvites } = useOrganisationInvitesQuery(
    initialOrganisation.id,
    {
        ...
        <Box display="flex" flexDir="column" w="100%" maxW="25rem" gap={6}>
          ...
          >
            ...
            <Box display="flex" gap={2}>
              <IconButton
                ...
                icon={<Icon as={ArrowLeft} w={4} h={4} />}
          ...
          <Box display="flex" flexDir="column" gap={4}>
            ...
            {organisationMemberships.length === 1 && (
              <ActionMessage>
                <Text>
                  You're the only member! Invite others to your organisation.
                </Text>
                <Button
                  as="a"
...
export async function getServerSideProps(context: NextPageContext) {
  ...
  return {
    props: {
      ...
      initialOrganisationMemberships: JSON.parse(
        JSON.stringify(organisation?.memberships),
      ),
